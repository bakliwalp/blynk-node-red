...
**NOTE** : Review `msg` format of each [node-red-contrib-blynk-ws/nodes](https://github.com/gablau/node-red-contrib-blynk-ws/tree/master/nodes).

for example (as of 9/16/2018), 
